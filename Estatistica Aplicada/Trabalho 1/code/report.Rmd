...
\vspace*{5 cm}
\Large{ANÁLISE SOBRE A INFLUÊNCIA DE UM PROGRAMA DE EXERCÍCIOS RESISTIDOS EM PACIENTES QUE FAZEM HEMODIÁLISE}

\vspace*{5 cm}
\Large{Luiz Fernando Coelho Passos, Lyncoln Sousa de Oliveira}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{../man/figures/ICAM.png}
\caption{Explicação sobre o boxplot.}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{../man/figures/IL6.png}
\caption{Explicação sobre o boxplot.}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{../man/figures/PCR.png}
\caption{Explicação sobre o boxplot.}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{../man/figures/TNFa.png}
\caption{Explicação sobre o boxplot.}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{../man/figures/VCAM.png}
\caption{Explicação sobre o boxplot.}
\end{figure}
