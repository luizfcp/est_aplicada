...
\hspace*{1.25 cm}Para as variáveis ICAM e PCR pode-se observar pelas \ref{fig:ICAM}, \ref{fig:PCR} e pela \ref{tab:inflamacao} uma diminuição de sua média e desvio padrão para a coleta de dados depois do REPET. Pelo teste-t, obtivemos de fato que houve diferença entre as médias de antes e depois do REPET. 

\hspace*{1.25 cm}Já para as variáveis IL6, TNFa e VCAM pode-se observar pelas \ref{fig:IL6}, \ref{fig:TNFa}, \ref{fig:VCAM} e pela \ref{tab:inflamacao} uma diminuição de sua média mas um crescimento no desvio padrão para a coleta de dados depois do REPET. Pelo teste-t, obtivemos de fato que houve diferença entre as médias de antes e depois do REPET. 
...
\hspace*{1.25 cm}Para a variável AMB pode-se observar pela \ref{fig:AMB} e pela \ref{tab:antropometricos} uma diminuição de sua média e desvio padrão para a coleta de dados depois do REPET. Pelo teste-t, obtivemos de fato que houve diferença entre as médias de antes e depois do REPET. 

\hspace*{1.25 cm}Já para as variáveis IMC e Massa Magra pode-se observar pelas \ref{fig:IMC}, \ref{fig:massa_magra} e pela \ref{tab:antropometricos} um aumento de sua média, porém um aumento e uma dimunuição, respectivamente, ppara o desvio padrão para a coleta de dados depois do REPET. Pelo teste-t, obtivemos de fato que houve diferença entre as médias de antes e depois do REPET. 
...
\hspace*{1.25 cm}Para as variáveis SL10 e Torque Extensor Esquerdo pode-se observar pelas \ref{fig:SL10}, \ref{fig:Torque Extensor Esquerdo} e pela \ref{tab:cf} uma diminuição de sua média e desvio padrão para a coleta de dados depois do REPET. Pelo teste-t, obtivemos de fato que houve diferença entre as médias de antes e depois do REPET para a variável SL10, já para a variável Torque Extensor Esquerdo obteve-se, pelo teste-t, que não houve diferença entre as médias de antes e depois do REPET.

\hspace*{1.25 cm}Já para as variáveis SL60, Torque Extensor Direito, Torque Flexor Direito e Torque Flexor Esquerdo pode-se observar pelas \ref{fig:SL60}, \ref{fig:Torque Extensor Direito}, \ref{fig:Torque Flexor Direito}, \ref{fig:Torque Flexor Esquerdo} e pela \ref{tab:cf} um aumento de sua média e desvio padrão para a coleta de dados depois do REPET. Pelo teste-t, obtivemos de fato que houve diferença entre as médias de antes e depois do REPET. 
